...
export const studyTemplates: StudyTemplate[] = [
  {
    ...
    tasks: [
      ...
      { title: 'Resolver bloco de exercicios ENEM', priority: 'alta', due_date: due(6), subject_id: null },
    ],
    goal: { target_hours: 18, target_tasks: 12, main_objective: 'Fechar uma semana com redacao, revisao e exercicios.' },
  },
  {
    id: 'concurso',
    ...
    tasks: [
      ...
      { title: 'Resolver caderno de questoes', priority: 'alta', due_date: due(6), subject_id: null },
    ],
